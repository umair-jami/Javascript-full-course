...
//how return more than one variable at a time
function shriaullah() {
  let biryani = "cook biryani";
  let karachi = "matan karahi";
  return [biryani, karachi];
}
const [a, b] = shriaullah();
console.log(a);
console.log(b);
console.log(shriaullah());
//function expression
function Hafizshriaullah() {
  let biryani = "cook biryani";
  let karachi = "matan karahi";
  return { a: biryani, b: karachi };
}
const hlo = Hafizshriaullah();
console.log(hlo.a);
console.log(hlo.b);
